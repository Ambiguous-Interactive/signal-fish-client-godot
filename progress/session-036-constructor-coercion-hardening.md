...
constructor coercion holes on direct construction (session-033 leftover) - plus resolving PLAN section 13 items 3/9 against upstream and a coverage-neutral
...
## PLAN section 13 items 3/9 resolved (upstream verified)
...
- Plus the section 13 item 9 `join_room`-omit pin and three builder-side
...
- PLAN section 13 items 4-8, 10 remain open verification work; P7 (Godot 3.6,
